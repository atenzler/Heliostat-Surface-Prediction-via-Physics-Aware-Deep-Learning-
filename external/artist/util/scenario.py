...
class Scenario:
    ...
    def load_scenario_from_hdf5(
        cls, scenario_file: h5py.File, control_points_available: bool = False, device: Union[torch.device, str] = "cuda"
    ) -> Self:
        """
        ...
        heliostat_field = HeliostatField.from_hdf5(
            ...
            control_points_available = control_points_available,
            device=device,
        )
    ...
    # return surface as part of the class somehow?
